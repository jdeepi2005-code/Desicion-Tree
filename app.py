...
def load_assets():
    ...
    model_path = os.path.join('models', '/content/drive/MyDrive/Colab Notebooks/model/DecisionTree_iris.pkl')
    le_path = os.path.join('models', '/content/drive/MyDrive/Colab Notebooks/model/LabelEncoder_iris.pkl')
